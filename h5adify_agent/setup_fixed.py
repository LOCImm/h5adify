#!/usr/bin/env python3
"""
h5adify - Setup script (Fixed Version with Working Entry Points)
...
setup(
    ...
    entry_points={
        "console_scripts": [
            "h5adify-agent=h5adify.working_terminal_agent_fixed:main",
            "h5adify-gui=h5adify.working_gui_launcher_pyqt5:main",
        ],
    },
    package_data={
        "h5adify": [
